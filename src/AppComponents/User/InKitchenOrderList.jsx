...
import InKitchenOrderView from "../ReuseableCompononts/InKitchenOrderView"

export default function AlmostReasyOrderList(props) {
        ...
        <div>
            ...
            <div class="table-responsive" >
                <table class="table">
                    ...
                    {oderData.map(data =>  <InKitchenOrderView data={data}  loadUOrderData={loadUOrderData} {...props}/> )}
                    </tbody>
                    <InfiniteScroll

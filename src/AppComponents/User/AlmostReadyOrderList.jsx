...
import AlmostReadyOrderView from "../ReuseableCompononts/AlmostReadyOrderView"

export default function AlmostReadyOrderList(props) {
    ...
    const loadUOrderData = () => {
        setLoading(true);
        axios
            .get('https://server.wakameals.validprofits.xyz/api/chef/order/list/almost_ready', {
                headers: {
                    Authorization: `Bearer ${user}`,
                    'Content-Type': 'application/json',
                    Accept: 'application/json'
        ...
        <div>
            ...
            <div class="table-responsive" >
                <table class="table">
                    ...
                    {oderData.map(data =>  <AlmostReadyOrderView data={data}  loadUOrderData={loadUOrderData} {...props}/> )}
                    </tbody>
                    <InfiniteScroll
